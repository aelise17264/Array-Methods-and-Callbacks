...
const finalMatchUp = finalHome.filter((index) =>{
    return index.Stage === "Final";
});
console.log(finalMatchUp);

const homeTeam = finalMatchUp.filter((index) =>{
...
const finalWinner = finalMatchUp.filter((index) => {
